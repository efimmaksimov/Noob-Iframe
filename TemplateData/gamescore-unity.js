(() => {
    ...
    class e {
        constructor(e, t) {
            this.gs = e, this.unity = t, document.addEventListener("touchstart", (() => {
                container.focus(), window.focus(), canvas.focus(), console.log("Click - Touch")
            })), document.addEventListener("pointerdown", (() => {
                container.focus(), window.focus(), canvas.focus(), console.log("pointer down")
        ...
        LeaderboardScopedOpen(e, t, r, s, i, a, l, n) {
            return this.gs.leaderboard.openScoped({
                ...
                order: s,
                limit: Number(i),
                includeFields: l.split(",").map((e => e.trim())).filter((e => e)),
                displayFields: n.split(",").map((e => e.trim())).filter((e => e)),
                withMe: a
            }).catch(console.warn)
        }
        ...
        LeaderboardScopedPublishRecord(e, t, r, s, i, a, l) {
